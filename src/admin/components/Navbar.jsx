        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:flex items-center">
              <div className="flex space-x-4">
                ...
                <Link to="/admin/add-feast" className={getLinkClass('/admin/add-feast')}>
                  Add Feast
                </Link>
                <Link to="/admin/edit-menu" className={getLinkClass('/admin/edit-menu')}>
                  Edit Menu
                </Link>
                <Link to="/admin/weeks-menu" className={getLinkClass('/admin/weeks-menu')}>
                  Weekly Rating
                </Link>
                <Link to="/admin/feedback" className={getLinkClass('/admin/feedback')}>
                  Feedback
                </Link>
              </div>
            </div>
            ...
            >
              ...
              <div className="flex flex-col px-4 pt-2 pb-3 space-y-3 dark:text-white">
                ...
                <Link
                  to="/admin/add-feast"
                  className={getLinkClass('/admin/add-feast')}
                  onClick={toggleMenu}
                >
                  Add Feast
                </Link>
                <Link
                  to="/admin/edit-menu"
                  className={getLinkClass('/admin/edit-menu')}
                  onClick={toggleMenu}
                >
                  Edit Menu
                </Link>
                <Link
                  to="/admin/weeks-menu-rating"
                  className={getLinkClass('/admin/weeks-menu')}
                  onClick={toggleMenu}
                >
                  Weekly Rating
                </Link>
          ...
          >
            ...
            <Link
                ...
                <Link
                  to="/admin/feedback"
                  className={getLinkClass('/admin/sick-meal')}
                  onClick={toggleMenu}
                >
                  Feedback
                </Link>
